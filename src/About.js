...
const About = () => {
   ...
   const [randomZ, setRandomZ] = useState(0);
    ...
    return ( 
        <section className="session-wrapper" aria-labelledby="about-heading">
            <ParallaxProvider>
            <Fade direction='down' fraction={0.3}>
                <div className="about">
                    <h2 className="title" id="about-heading">~ About me</h2>
...
workflow, and collaborating with teams to build meaningful software solutions.</span>
            ...
            <Parallax className="photos" speed={-17}>
                ...
                <div className="photo-wrapper">
                    <img src={profile} alt="Portrait of Sanjai Arivu" />
                </div>
            </Parallax>
            </ParallaxProvider>
        </section>
